...
Begin
   ...
   //
   slResult := PromptFor3Strings('Set Int[] property', 'Add property to what script?', 'Create a new int array property named...', 'Enter the value of the new property as a list of comma-separated integers. No spaces, please.');
...
Begin
   If ElementType(e) = etMainRecord Then
      If ElementExists(e, 'VMAD') Then
         SetIntArrayPropertyOnScript(GetScript(e, sScriptTarget), sNewPropertyName, slNewPropertyValues);
End;
